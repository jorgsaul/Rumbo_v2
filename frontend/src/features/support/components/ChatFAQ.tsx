      ...
      >
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, var(--atlas-accent), var(--color-primary-300, #ee68a4))",
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              <span
                ...
                style={{
                  background: "var(--atlas-online)",
                  boxShadow: "0 0 4px var(--atlas-online)",
                }}
              />
              <span
        ...
        >
          ...
          {cargando && (
            <div className="flex items-end gap-2 animate-atlas-fade-up">
              ...
              >
                <span
                  className="w-[7px] h-[7px] rounded-full animate-chat-bounce"
                  style={{ background: "var(--atlas-text-muted)" }}
                />
                <span
                  className="w-[7px] h-[7px] rounded-full animate-chat-bounce-delay-1"
                  style={{ background: "var(--atlas-text-muted)" }}
                />
                <span
                  className="w-[7px] h-[7px] rounded-full animate-chat-bounce-delay-2"
                  style={{ background: "var(--atlas-text-muted)" }}
                />
              </div>
            </div>
