export const questions = [
  {
    ...
    pilar: "PASION",
    texto:
      "¿Cuánto te interesan los temas relacionados con tecnología y programación?",
    tipo: "likert_5",
    categoria: "pasion",
    palabras_clave: [
      "Programación",
  ...
  },
  {
    ...
    pilar: "PASION",
    texto:
      "¿Qué tanto disfrutas trabajar en proyectos relacionados con salud y medicina?",
    tipo: "likert_5",
    categoria: "pasion",
    palabras_clave: [
      "Salud",
  ...
  },
  {
    ...
    pilar: "PASION",
    texto:
      "¿Te apasionan los temas de construcción, infraestructura y urbanismo?",
    tipo: "likert_5",
    categoria: "pasion",
    palabras_clave: [
      "Construcción",
  ...
  },
  {
    ...
    pilar: "PASION",
    texto:
      "¿Cuánto te interesa el mundo de los negocios, finanzas y emprendimiento?",
    tipo: "likert_5",
    categoria: "pasion",
    palabras_clave: [
      "Negocios",
  ...
  },
  {
    ...
    pilar: "PASION",
    texto:
      "¿Qué tanto te atrae trabajar con procesos químicos, farmacéuticos o biotecnológicos?",
    tipo: "likert_5",
    categoria: "pasion",
    palabras_clave: [
      "Química",
  ...
  },
  {
    ...
    pilar: "PASION",
    texto:
      "¿Te gustaría trabajar principalmente en un laboratorio realizando experimentos e investigación?",
    tipo: "likert_5",
    categoria: "pasion",
  ...
  },
  {
    ...
    pilar: "PASION",
    texto:
      "¿Prefieres actividades de diseño, creación visual o desarrollo de productos?",
    tipo: "likert_5",
    categoria: "pasion",
  ...
  },
  {
    ...
    pilar: "PASION",
    texto:
      "¿Disfrutas analizar grandes cantidades de datos y encontrar patrones?",
    tipo: "likert_5",
    categoria: "pasion",
  ...
  },
  {
    ...
    pilar: "PASION",
    texto:
      "¿Te atrae la idea de trabajar al aire libre o en contacto con la naturaleza?",
    tipo: "likert_5",
    categoria: "pasion",
  ...
  },
  {
    ...
    pilar: "PASION",
    texto:
      "¿Qué tan importante es para ti que tu trabajo involucre alta creatividad e innovación?",
    tipo: "likert_5",
    categoria: "pasion",
    atributo: "creatividad",
  },

  // VOCACION (10 preguntas)
  {
    id: 11,
    pilar: "VOCACION",
  ...
  },
  {
    ...
    pilar: "VOCACION",
    texto:
      "¿Qué tan desarrollada está tu capacidad de pensamiento crítico y análisis?",
    tipo: "likert_5",
    categoria: "vocacion",
  ...
  // PROFESION (10 preguntas)
  {
    id: 21,
    pilar: "PROFESION",
    texto:
      "¿Qué tan importante es para ti tener un salario inicial alto (arriba de $20,000)?",
    tipo: "likert_5",
    categoria: "profesion",
  ...
  },
  {
    ...
    pilar: "PROFESION",
    texto:
      "¿Te gustaría trabajar en el sector salud (hospitales, clínicas, farmacéuticas)?",
    tipo: "likert_5",
    categoria: "profesion",
  ...
  },
  {
    ...
    pilar: "PROFESION",
    texto:
      "¿Qué tanto te atrae la idea de trabajar en gobierno o sector público?",
    tipo: "likert_5",
    categoria: "profesion",
  ...
  },
  {
    ...
    pilar: "PROFESION",
    texto:
      "¿Qué tan importante es para ti tener oportunidades de emprender tu propio negocio?",
    tipo: "likert_5",
    categoria: "profesion",
  ...
  },
  {
    ...
    pilar: "PROFESION",
    texto:
      "¿Priorizas una carrera con muy alta demanda laboral aunque no sea tu principal interés?",
    tipo: "likert_5",
    categoria: "profesion",
    aspecto: "demanda",
  },
  ...
  },
  {
    ...
    pilar: "PROFESION",
    texto:
      "¿Qué tan importante es para ti que la carrera ofrezca oportunidades de crecimiento rápido?",
    tipo: "likert_5",
    categoria: "profesion",
    aspecto: "crecimiento",
  },
  ...
  // MISION (10 preguntas)
  {
    ...
    pilar: "MISION",
    texto:
      "¿Qué tan importante es para ti contribuir a resolver problemas ambientales?",
    tipo: "likert_5",
    categoria: "mision",
  ...
  },
  {
    ...
    pilar: "MISION",
    texto:
      "¿Qué tanto te interesa contribuir al desarrollo tecnológico del país?",
    tipo: "likert_5",
    categoria: "mision",
  ...
  },
  {
    ...
    pilar: "MISION",
    texto:
      "¿Te motiva trabajar en proyectos de infraestructura que mejoren comunidades?",
    tipo: "likert_5",
    categoria: "mision",
  ...
  },
  {
    ...
    pilar: "MISION",
    texto:
      "¿Te interesa contribuir a la investigación científica y generación de conocimiento?",
    tipo: "likert_5",
    categoria: "mision",
  ...
  },
  {
    ...
    pilar: "MISION",
    texto:
      "¿Qué tanto te motiva trabajar en soluciones contra el cambio climático?",
    tipo: "likert_5",
    categoria: "mision",
  ...
  },
  {
    ...
    pilar: "MISION",
    texto:
      "¿Qué tan importante es para ti que tu trabajo tenga un alto impacto social visible?",
    tipo: "likert_5",
    categoria: "mision",
  ...
  },
  {
    ...
    pilar: "MISION",
    texto:
      "¿Te motiva contribuir al desarrollo económico y competitividad del país?",
    tipo: "likert_5",
    categoria: "mision",
...
export const careers = [
  {
    ...
    vocacion: {
      ...
      habilidades_tecnicas: [
        ...
        "Física aplicada",
        "Manejo de software especializado (CAD, CAE, CAM)",
        "Aerodinámica (Física aplicada)",
  ...
  },
  {
    ...
    vocacion: {
      ...
      habilidades_tecnicas: [
        ...
        "Física aplicada",
        "Análisis de sistemas",
        "Operación de equipos especializados",
      ],
      habilidades_blandas: [
        "Pensamiento crítico",
        "Resolución de problemas",
  ...
  },
  {
    ...
    vocacion: {
      ...
      habilidades_blandas: [
        "Pensamiento analítico",
        "Resolución de problemas",
        "Observación (Atención al detalle)",
        "Resiliencia",
      ],
      dificultad_academica: 8,
    },
  ...
  },
  {
    ...
    mision: {
      problemas: [
        "Problemas de salud y enfermedades (Visual)",
        "Diagnóstico y tratamiento médico",
      ],
      impacto_social: 7,
      sectores_impacto: ["Salud", "Social"],
  ...
  },
  {
    ...
    vocacion: {
      ...
      habilidades_tecnicas: [
        "Metodologías de investigación",
        "Estadística y probabilidad",
        "Anatomía y fisiología (Psico-fisiología)",
        "Normatividad y regulaciones",
      ],
      habilidades_blandas: [
        "Comunicación efectiva",
